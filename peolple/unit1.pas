...
procedure TForm1.proffesClick(Sender: TObject); {Поиск по професии.Запрашивает путь к фаилу, имя фаила и профессию. Выводит фамилию имя профессию и телефон}
var vr: tslug;
  f: tf;
  pass,vivod:string;
  imia:string[20];
...
procedure TForm1.textfile1Click(Sender: TObject); {Создание 1 текстового фаила.Перепи сывание из типизированного основного дохода,премии и налога }
var vr: tslug;
  f: tf;
  tf:textfile;
...
procedure TForm1.textfile2Click(Sender: TObject); {Создание 2 текстового фаила.Переписывание из 1-го текстового общего дохода,основоного дохода,премии и налога }
var f1,f2:textfile;
  res,resint:string;
...
procedure TForm1.vievingfailClick(Sender: TObject); {Вывод записей из фаила на экран. запрашивает путь,имя файла Вызывает форму для вывода.}
var vr: tslug;
  f: tf;
  pass:string;
  imia:string[20];
